...
public class SwerveModuleSparkMax implements SwerveModuleIO {
	...
	public SwerveModuleSparkMax(int index) {
		...
		turnMotor = new SparkMax(DriveConstants.turningMotorPorts[index], SparkMax.MotorType.kBrushless);
	...
	public void setDriveVoltage(double volts) {
		driveAppliedVolts = MathUtil.clamp(volts, -DriveConstants.maxMotorVolts, DriveConstants.maxMotorVolts);
	...
	public void setTurnVoltage(double volts) {
		turnAppliedVolts = MathUtil.clamp(volts, -DriveConstants.maxMotorVolts, DriveConstants.maxMotorVolts);
