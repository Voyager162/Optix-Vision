...
public class SwerveConstants {
  public static final class ModuleConstants {
    ...
    // our PID values
    public static double kPturning = Robot.isReal() ? kPTurningReal : kPTurningSim;
    public static double kDTurning = Robot.isReal() ? kDTurningReal : kDTurningSim;
    public static double kPDriving = Robot.isReal() ? kPDrivingReal : kPDrivingSim;
    public static double kSDriving = Robot.isReal() ? kSDrivingReal : kSDrivingSim;
    public static double kVDriving = Robot.isReal() ? kVDrivingReal : kVDrivingSim;
    public static double kADriving = Robot.isReal() ? kADrivingReal : kADrivingSim;
  }
  ...
  public static final class DriveConstants {
    ...
    public static final boolean[] driveMotorReversed = {true, false, false, false};
    ...
    public static final double[] absoluteEncoderOffsetDeg = {26.191, 137.594, 71.455, 186.943};
    ...
    // acceleration
    private static final double realMaxAccelerationMetersPerSecondSquared =
        3.3; // actual top acceleration
    private static final double simMaxAccelerationMetersPerSecondSquared =
        6; // not entirely accurate
    public static final double maxAccelerationMetersPerSecondSquared =
        Robot.isReal()
            ? DriveConstants.realMaxAccelerationMetersPerSecondSquared
            : DriveConstants.simMaxAccelerationMetersPerSecondSquared;
    // teleop speed
    public static final double teleopMaxSpeedReduction =
        0; // If we can drive a little faster in telop
    // we may as well
    public static final double teleopMaxSpeedMetersPerSecond =
        maxSpeedMetersPerSecond * (1 - teleopMaxSpeedReduction);

    // auto speed
    public static final double autoMaxSpeedReduction = 0;
    public static final double autoMaxSpeedMetersPerSecond =
        maxSpeedMetersPerSecond * (1 - autoMaxSpeedReduction);
    ...
    public static final double maxAngularAccelerationRadiansPerSecondSquared =
        Robot.isReal()
    ...
    public static final double teleopMaxAngularSpeedRadPerSecond =
        maxAngularSpeedRadiansPerSecond * (1 - teleopMaxAngularSpeedReduction);

    // auto angular speed
    public static final double autoMaxAngularSpeedReduction = 0;
    public static final double autoMaxAngularSpeedRadPerSecond =
        maxAngularSpeedRadiansPerSecond * (1 - autoMaxAngularSpeedReduction);

    // motor volts
    private static final double simMaxMotorVoltage = 12.0;
    private static final double realMaxMotorVoltage = 12.0;
    public static final double maxMotorVolts =
        Robot.isReal() ? DriveConstants.realMaxMotorVoltage : DriveConstants.simMaxMotorVoltage;
  }
}
