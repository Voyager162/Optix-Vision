...
public class CoralArm extends Arm {
  ...
  private PIDController controller =
      new PIDController(CoralConstants.kP, CoralConstants.kI, CoralConstants.kD);
  ...
  private LoggedMechanismLigament2d armLigament =
      armRoot.append(new LoggedMechanismLigament2d("Coral Arm", 24, 0));

  /** Constructor for the CoralArm subsystem. Determines if simulation or real hardware is used. */
  public CoralArm() {
