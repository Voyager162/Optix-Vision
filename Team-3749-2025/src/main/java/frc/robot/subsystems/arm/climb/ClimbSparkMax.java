...
/**
 * IO implementation for the climb subsystem's sparkmax I had to make two
 * different motors because
 * we are using two motors on the climb I have decided to have one of the motors
 * be the primary
 * motor taking care of all the data the secondary will just be there to provide
 * more power to the
 * climb
 *
 * @author Elise Lin
