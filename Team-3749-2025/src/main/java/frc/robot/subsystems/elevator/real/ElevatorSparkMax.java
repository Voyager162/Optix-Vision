...
public class ElevatorSparkMax implements ElevatorIO {
  private SparkMax leftMotor =
      new SparkMax(ElevatorConstants.ElevatorSpecs.motorIds[0], MotorType.kBrushless);
  private SparkMax rightMotor =
      new SparkMax(ElevatorConstants.ElevatorSpecs.motorIds[1], MotorType.kBrushless);
  ...
  public ElevatorSparkMax() {
    ...
    leftConfig.smartCurrentLimit(
        ElevatorConstants.ElevatorSpecs.stallLimit, ElevatorConstants.ElevatorSpecs.freeLimit);
  ...
  public void updateData(ElevatorData data) {
    ...
    //         + absolutePos;
    data.positionMeters =
        (leftMotor.getEncoder().getPosition() + rightMotor.getEncoder().getVelocity()) / 2;
