...
public class Elevator extends SubsystemBase {
    ...
    private ShuffleData<Double> velocityMetersPerSecLog = new ShuffleData<Double>("Elevator", "velocity meters per sec", 0.0);
    private ShuffleData<Double> accelerationMetersPerSecLog = new ShuffleData<Double>("Elevator", "acceleration meters per sec", 0.0);
