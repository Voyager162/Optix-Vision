...
public class ScoreL3 extends Command {
    ...
    public ScoreL3(Chute chute, CoralArm coralArm, Elevator elevator, Roller[] rollers) {
        this.chute = chute;
        this.coralArm = coralArm;
        this.elevator = elevator;
        this.rollers = rollers;
        this.setElevatorState = new SetElevatorState(ElevatorStates.L3);
    }
    ...
    public void execute() {
        ...
        if (chute.hasPiece() && coralArm.getState() == CoralConstants.ArmStates.CORAL_PICKUP && coralArm.getIsStableState() && elevator.getState() == ElevatorStates.L3 && elevator.getIsStableState()) {
    ...
    public boolean isFinished() {
        return elevator.getState() == ElevatorStates.L3 && !chute.hasPiece();
    }
}
