...
/**
 * All setup and helper methods for auto routines, including the choreo factory
 * and auto selector
 *
 * @author Noah Simon
 */
public class AutoUtils {
	...
	private static void setupFactory(boolean isFlipped) {
		/**
		 * Swerve Pose Supplier Reset Odometry Method Swerve Controller (PID and set
		 * chassis speeds)
		 * Alliance Supplier for swapping Swerve Subsystem for scheduling Bindings,
		 * created above
		 */
	...
	/**
	 * Each pos will be flipped across the X-axis using Choreo's Flip Util Returns
	 * new pos Used in
