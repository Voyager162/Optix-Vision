...
public class ShuffleData<T> {
  ...
  /**
   * checks whether the number has changed since the last time this method has been called
   *
   * @param id Unique identified for the called to avoid conflicts shared between multiple
   *     instances. Recommended to pass in the result of 'Obj.hashCode()'
